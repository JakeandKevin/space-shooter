...
public class playerMove : MonoBehaviour
{
	...
	private bool left = false, right = false, space = false;
	...
	void Update ()
    {
        ...
        {   
            //Vector for player
            Vector3 newPlayer = new Vector3(player.transform.position.x - .5f, player.transform.position.y, player.transform.position.z);
	...
	/*Method instantiates new shot as GameObject in scene*/
	public void shoot()
	{
		Instantiate(shot, new Vector3(player.transform.position.x, player.transform.position.y + .25f, player.transform.position.z), Quaternion.identity);
